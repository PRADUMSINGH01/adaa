...
const CartPage = () => {
  ...
  useEffect(() => {
    if (!loading && userData?.Address?.length > 0) {
      // If only one address exists, set it as default
        ...
        <main className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex flex-col justify-between items-center">
              <h1 className="text-2xl font-bold mb-2 font-playfair flex items-center">
                Select Delivery Address
              </h1>
              <p className="text-gray-600 mb-6 text-center">
                {userData?.Address?.length > 0
                  ? "Select a delivery address. Your order will be delivered to this address."
              ...
              <div className="w-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {userData.Address.map((address, index) => (
                    <div
                      key={index}
                      className={`group border rounded-xl p-5 bg-white shadow-sm relative transition-all duration-300 cursor-pointer hover:border-primary/60 hover:shadow-md ${
                ...
                {userData.Address.length === 1 && !selectedAddress && (
                  <div className="mt-4 text-center text-sm text-gray-500">
                    <p>Your only address has been automatically selected.</p>
                  </div>
                )}
              </div>
            ) : (
        ...
        {selectedAddress && (
          <main className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="w-full">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="border border-primary rounded-xl p-5 bg-primary/5 shadow-sm">
                    <div className="flex items-start gap-4">
                      <div className="bg-primary/10 rounded-full p-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 sticky top-20">
                    ...
                    <div className="mt-6">
                      {selectedAddress ? (
                        ...
                        <button
                          disabled
                          className="w-full bg-gray-400 text-white py-3 px-4 rounded-md text-sm sm:text-base font-medium cursor-not-allowed"
                        >
