...
const CartPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E6] font-poppins text-[#4A4A48]">
      ...
      <header className="bg-white shadow-sm sticky top-18 z-50 py-3">
              ...
              <div className="w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {addresses.map((address) => (
                    <div
                      key={address.id}
                      className={`border rounded-lg p-4 relative transition-all duration-200 cursor-pointer hover:border-primary hover:shadow-sm ${"border-primary border-2 bg-primary/5"}`}
                    ...
                    >
                      ...
                      <div className="flex items-start mb-2">
                        <div className="bg-gray-100 p-2 rounded-full mr-3"></div>
                        <div>
